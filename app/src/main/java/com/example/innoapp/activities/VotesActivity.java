...
public class VotesActivity extends Activity {
    ...
    public static LinkedList<Group> groups;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        groups.add(new Group("Group 1", new HashMap<>()));
        groups.add(new Group("Group 2", new HashMap<>()));
        groups.add(new Group("Group 3", new HashMap<>()));
        groups.add(new Group("Group 4", new HashMap<>()));
        groups.add(new Group("Group 5", new HashMap<>()));
        groupsS1 = new String[groups.size()];
        for (int i = 0; i < groups.size(); i++) {
            groupsS1[i] = groups.get(i).name;
        }
